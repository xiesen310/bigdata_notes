...
* [Val、def、lazy定义变量的区别](#val-def-lazy定义变量的区别)
* [List](#list)
	* [reduce](#reduce)
	* [fold](#fold)
	* [foldLeft](#foldleft)
...
* [Map](#map)
	...
	* [Map取值](#map取值)
	* [Map遍历](#map遍历)
	* [通过get获取key的value值](#通过get获取key的value值)
	* [Map ++](#map)
	* [Map中判断是否包含key](#map中判断是否包含key)
	* [Map count](#map-count)
	* [Map drop](#map-drop)
	* [Map filter](#map-filter)
	* [flatMap 展平](#flatmap-展平)
	* [Map groupby](#map-groupby)
	* [Head tail init last](#head-tail-init-last)
	* [Map方法，对kv对进行映射转换](#map方法对kv对进行映射转换)
	* [key 最大最小值](#key-最大最小值)
	* [Reduce](#reduce)
	* [Fold](#fold)
	* [foldLeft,foldRight,aggregate](#foldleftfoldrightaggregate)
	* [可变map的声明](#可变map的声明)
* [元组](#元组)
	* [元组的声明](#元组的声明)
	* [元组的取值](#元组的取值)
	* [元组封装返回值](#元组封装返回值)
* [OPtion、None、Some类型](#option-none-some类型)
	* [None](#none)
	* [some](#some)
